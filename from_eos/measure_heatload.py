...
special_q1 = vlh['special_HC_Q1']
special_d2 = vlh['special_HC_D2']
special_d3 = vlh['special_HC_D3']
special_d4 = vlh['special_HC_D4']
...
hl_varlist = hc_varlist + arc_avg_varlist + q4d2_varlist + q6_varlist  \
              + q5_varlist + special_q1 +  special_d2 + special_d3 + special_d4
...
assign_heat("special_Q1", special_q1, meas_hl, heatloads)
assign_heat("special_D2", special_d2, meas_hl, heatloads)
assign_heat("special_D3", special_d3, meas_hl, heatloads)
assign_heat("special_D4", special_d4, meas_hl, heatloads)
...
#    timber_var = heatloads.timber_variables[kk]
#    hl = timber_var.nearest_older_sample(t_obs_h*3600 + t_ref)
#    print(f"{kk} : {hl:.2f} W")
#print(f"Impedance : {impedance_hl:.2f} W")
#print(f"Synch. rad. : {sr_hl:.2f} W")
